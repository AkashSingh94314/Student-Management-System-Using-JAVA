...
lblPhy = new JLabel("Enter Physics Marks: ");
lblChem = new JLabel("Enter Chemistry Marks: ");
lblMaths = new JLabel("Enter Maths Marks: ");
...
Validation.validateAdd(rno, sname, phy_m, chem_m, maths_m);
